    ...
    <main className="page-shell catalog-shell">
      ...
      <section className="hero compact-hero">
        ...
        <div className="hero-actions">
          ...
          <Link href={`/catalogs/${catalog.slug}/entities`} className="primary-button">Manage product entities</Link>
      ...
      <section className="section-block">
        <div className="section-heading-row"><div><p className="eyebrow">Product structure</p><h2>Product specifications and BOM hierarchy</h2></div><Link href={`/catalogs/${catalog.slug}/entities`} className="secondary-button">Add / edit specs</Link></div>
        <div className="detail-grid">
          <article className="card">
      ...
      <section className="section-block">
        <div className="section-heading-row"><div><p className="eyebrow">Commercial layer</p><h2>Product offerings</h2></div><Link href={`/catalogs/${catalog.slug}/entities`} className="secondary-button">Add / edit offerings</Link></div>
        <div className="table-scroll">
          <table className="catalog-table">
      ...
      <section className="section-block">
        <div className="section-heading-row"><div><p className="eyebrow">Product inventory</p><h2>Product instances</h2></div><Link href={`/catalogs/${catalog.slug}/entities`} className="secondary-button">Add / edit products</Link></div>
        <div className="table-scroll">
          <table className="catalog-table">
